    ...
    char *argv[])
{
     ...
     * Column 3 = Repository
     * Column 4 = Short Status
     * Column 5 = Real Status (hidden)
     */
    store_model =
        gtk_list_store_new(
            6,
    ...
    /*
     * Use separate renderers so the Status renderer
     * can have its own compact configuration.
     */
     ...
     * -- = not installed
     *
     * Therefore the column can really be narrow.
     */
    g_object_set(
        status_renderer,
        "xalign",
    ...
    /*
     * Hide the internal real-status column.
     * It is used only by the filter.
     */
