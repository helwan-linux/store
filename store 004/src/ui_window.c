    ...
    gpointer user_data)
{
    ...
    /*
     * Ignore queued progress updates after the
 ...
 *
 * This callback is called from the worker thread.
 * GTK is NOT touched here.
 * ========================================================= */
    ...
    void *user_data)
{
    ...
    /*
     * Send the update safely to GTK's main loop.
     */
    g_idle_add(
    ...
    void *data)
{
    ...
    /*
     * Stop receiving backend progress updates.
     */
    ...
    /*
     * Refresh package information after every operation.
     */
    reload_packages();
    ...
    const char *message)
{
    ...
    /*
     * Enable real backend progress reporting
    ...
    char *argv[])
{
    ...
    /*
     * Progress widgets must remain hidden initially.
     */
    gtk_widget_hide(
        progress_label
    );
    ...
    /*
     * Do not leave a callback pointing at the UI.
     */
    backend_set_progress_callback(
        NULL,
        NULL
